...
it('user should add new credits', done => {
        chai.request(app)
          .get('/api/v1/credits/d08a096f-6536-4507-aeca-f18f8234129f')
...
it('user should not get a single credits', done => {
    chai.request(app)
      .get('/api/v1/credits/d08a096f-6536-4507-aeca-f18f8234129f/11')
      .set('Authorization', `Bearer ${userToken}`)
      .end((error, res) => {
...
it('user should view credits with invalid id', done => {
    chai.request(app)
      .get('/api/v1/credits/d08a096f-6536-4507-aeca')
      .set('Authorization', `Bearer ${userToken}`)
      .end((error, res) => {
...
it('user should add new credits', done => {
    chai.request(app)
      .post('/api/v1/credits/d08a096f-6536-4507-aeca-f18f8234129f')
      .set('Authorization', `Bearer ${userToken}`)
...
it('user should get a single credits', done => {
    chai.request(app)
      .get('/api/v1/credits/d08a096f-6536-4507-aeca-f18f8234129f/1')
      .set('Authorization', `Bearer ${userToken}`)
      .end((error, res) => {
         res.should.have.property('status').eql(200);
        done();
...
it('user should not new credits with missing field', done => {
  chai.request(app)
    .post('/api/v1/credits/d08a096f-6536-4507-aeca-f18f8234129f')
    .set('Authorization', `Bearer ${userToken}`)
...
it('user should not new credits with aunothorized token', done => {
  chai.request(app)
    .post('/api/v1/credits/d08a096f-6536-4507-aeca-f18f8234129f')
...
it('user should not new credits with invalid token', done => {
  chai.request(app)
    .post('/api/v1/credits/d08a096f-6536-4507-aeca-f18f8234129f')
